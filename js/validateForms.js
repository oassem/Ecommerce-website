...
if (sessionStorage.getItem('LoginUser')) {
    ...
    cartNo = JSON.parse(localStorage.getItem("cart"));
    var mycart = document.getElementById('mycart');
    // mycart.innerHTML = `<i class="fa badge fa-lg" value="${cartNo.length}">&#xf07a;</i>${LoginUser}\'s Cart`;
    mycart.innerHTML=`${LoginUser}\'s Cart<span class="bshop" value="${cartNo.length}"><span>`;
